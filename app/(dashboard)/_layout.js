...
import CarsListing from '@/screens/Cars/CarsListing'
import Custormers from '@/screens/Customers/Customers'
import DriversListing from '@/screens/Drivers/DriverListings'
    ...
    return (
        <>
            <Drawer.Navigator
                ...
                <Drawer.Screen name='Cars' component={CarsListing} />
                <Drawer.Screen name='Customers' component={Custormers} />
                <Drawer.Screen name='Drivers' component={DriversListing} />
